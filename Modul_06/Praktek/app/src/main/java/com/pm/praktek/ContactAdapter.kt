...
class ContactAdapter (val phoneItemList: List<com.pm.praktek.PhoneData>, val clickListener: (com.pm.praktek.PhoneData) -> Unit) :
        RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    class PartViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bind(phone: com.pm.praktek.PhoneData, clickListener: (com.pm.praktek.PhoneData) -> Unit){
